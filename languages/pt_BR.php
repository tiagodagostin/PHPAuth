...
$lang['email_invalid'] = "Endereço de email inválido.";
$lang['email_incorrect'] = "Endereço de email incorreto.";
$lang['email_banned'] = "Endereço de email não é permitido.";
...
$lang['system_error'] = "O sistema encontrou um erro. Tente mais tarde.";
...
$lang['reset_requested'] = "A requisição de redefinição da senha foi enviada para o endereço de email.";
$lang['reset_requested_emailmessage_suppressed'] = "Requisição de redefinição da senha foi criada.";
$lang['reset_exists'] = "Esta requisição já existe. Nova requisição de redefinição de senha estará disponível em %s";

$lang['already_activated'] = "Esta conta já está ativada.";
$lang['activation_sent'] = "Email de ativação enviado com sucesso.";
$lang['activation_exists'] = "Um email de ativação já foi enviado. Próxima reativação estará disponível em %s";

$lang['email_activation_subject'] = '%s - Ativação da conta';
$lang['email_activation_body'] = 'Olá,<br/><br/> Para logar-se em sua conta é necessária ativá-la primeiro no seguinte link: <strong><a href="%1$s/%2$s">%1$s/%2$s</a></strong><br/><br/> Em seguida você deve utilizar a seguinte chave de ativação: <strong>%3$s</strong><br/><br/> Se você não se cadastrou em %1$s recentemente, por favor ignore este email.';
...
$lang['account_deleted'] = "Conta apagada com sucesso.";
$lang['function_disabled'] = "Esta função foi desabilitada.";
$lang['account_not_found'] = "Nenhuma conta encontrada com este endereço de e-mail.";
